...
import com.example.healthapp.adapter.QuestionAdapter
import com.example.healthapp.data.Question
    ...
    override fun onCreateView(
        ...
        if(prefs.forumAlert == -1){
            ...
            alert.setNegativeButton("Cancel") { dialog, which ->
                ...
                rootView.findNavController().navigate(R.id.action_navigation_forum_to_navigation_information)
            }
    ...
    private fun setUpRecyclerView(rootView : View) {
        ...
        adapter.setOnItemClickListener(object : QuestionAdapter.OnItemClickListener {
            override fun onItemClick(documentSnapshot: String) {
                ...
                closeKeyboard()
                rootView.findNavController().navigate(R.id.action_navigation_forum_to_replyFragment, bundle)
            }
        })
    }
